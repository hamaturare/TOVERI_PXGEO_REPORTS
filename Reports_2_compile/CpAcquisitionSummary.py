...
def check_file():
    ...
    try:
        ...
        if os.path.exists(input_file_recovery):   
         ...
         print('Verify if the excel sheet Yesterdays_Production_Deployed/Recovered exists on the Desktop')
...
class CpAcquisitionSummary():
    ...
    def get_node_summary(self):
        ...
        line_counts_deploy = line_counts_deploy.sort_index()  
        ...
        line_counts_recovery = line_counts_recovery.sort_index()
