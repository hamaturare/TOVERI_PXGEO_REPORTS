...
# Calculate deltas
df['delta_x'] = df['Recovered Easting'] - df['Preplot Easting']
df['delta_y'] = df['Recovered Northing'] - df['Preplot Northing']
...
ax.set_title('Recovered to Preplot Distance Distribution')
