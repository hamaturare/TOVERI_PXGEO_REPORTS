...
columns = ['RL', 'Station','X_preplot','Y_preplot','X_seismic','Y_seismic','Azimuth-seismic']
#df = df[columns]
...
ax.set_xticks([])
ax.set_yticks([])
ax.set_title('Seismic to Preplot Distance with Azimuth')
